      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        @php
          if (!empty(Auth::user()->img))
              ...
              $image = 'no_image.jpg';
        @endphp
        <div class="image nav-user-image">
        ...
        <a href="{{ route('user.edit', [Auth::user()->id]) }}" class="edit-btn cursor-pointer">
...
<script src="https://cdn.tiny.cloud/1/kra879u598pjhq8vtnfjsdco0ppakjjlcrlhy2qbd91vz3qm/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
